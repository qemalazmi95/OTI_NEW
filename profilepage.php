...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
        ...
        <div class="container-fluid">
            ...
            <div class="card mb-3">
                ...
                <div class="card-header">
                    <i class="fa fa-bar-chart"></i>My Profile</div>
                <div class="card-body">
 ...
 <?php if($image!= null) { ?> 
                              <img src="upload/<?php echo $image; ?>" width="300" height="300" style=" border-radius: 50%">
                              <?php } else { ?>
                               <img src="upload/img-default.png" width="300" height="300" style=" border-radius: 50%">
                               <?php }?>
                    </div>
					...
					<br />
                        ...
                        <div class="form-group col-md-6 offset-md-3 ">
					<label>Ic</label>
					<input type="text" name="ic" id="ic" class="form-control" value="<?php echo $ic  ?>" disabled/>
					<br />
                        </div>
                    </div>
					...
					<br />
                        ...
                        <div class="form-group col-md-6 offset-md-3 ">
                    <label>Role</label>
                    <input type="text" name="role" id="role" class="form-control" value="<?php echo $role  ?>" disabled/>
					<br />
                        </div>
                    </div>
					...
					<input type="text" name="phone" id="phone" class="form-control" value="<?php echo $phone  ?>" disabled/>
					<br />
                        </div>
                        <div class="form-group col-md-6 offset-md-3 ">
                    <label>Address</label>
					<input type="text" name="address" id="address" class="form-control" value="<?php echo $address  ?>"disabled/>
					<br />
                        </div>
                    </div>
